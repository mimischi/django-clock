...
class ShiftsViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.contract1 = Contract.objects.create(employee=self.user1, department='Test department', hours='40')
    ...
    def test_login_required_for_shift_views(self):
        ...
        self.assertLoginRequired('shift:archive_day', year=2016, month=6, day=10)
        ...
        self.assertLoginRequired('shift:archive_month_contract_numeric', year=2016, month=5, contract=0)
    ...
    def test_logged_in_shift_views(self):
        ...
        with self.login(username=user1.username, password='password'):
            ...
            self.get_check_200('shift:archive_month_contract_numeric', year=2016, month=5, contract=0)
