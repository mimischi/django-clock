...
from clock.profiles.forms import DeleteUserForm, UpdateUserForm
...
def update_language(request):
    """This is a very lazy solution overwriting django.views.i18n.set_lang. We're
    basically just adding another option to save the selected language into the
    database, besides the session. This way we can retrieve the language
    preference across different devices and after a longer period of time, when
    the user was not logged in.

    It's possible, that there is a nifty trick on how to make this whole thing
