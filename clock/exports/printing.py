...
class BoxyLine(Flowable):
    ...
    def __init__(self,
        ...
        self.styles.add(
            ParagraphStyle(
                name='HeadText', fontName='OpenSans-Regular', fontSize=10))
...
class ShiftExport:
    ...
    def _header_footer(canvas, doc):
        ...
        styles.add(
            ParagraphStyle(
                name='NormalText', fontName='OpenSans-Regular', fontSize=10))
        styles.add(
            ParagraphStyle(
                name='BottomText', fontName='OpenSans-Regular', fontSize=8))
        styles.add(
            ParagraphStyle(
                name='Schluessel',
                alignment=TA_CENTER,
        ...
        frame1 = Frame(
            200, doc.bottomMargin, 125, 40, showBoundary=1, topPadding=10)
    ...
    def print_shifts(self):
        ...
        h5_total = Paragraph('''Dauer<br />(Summe ohne Pausen)''',
                             styles["BoldText"])
