...
class ExportViewTest(TestCase):
    def test_login_required_for_pdf_export(self):
        ...
        self.assertLoginRequired('export:contract_nuke', year=2016, month=1, pk=1, hours=40)
    ...
    def test_logged_in_pdf_export(self):
        ...
        contract = Contract.objects.create(employee=user1, department='Test contract', hours='40')

        with self.login(username=user1.username, password='password'):
            self.get_check_200('export:contract', year=2016, month=1, pk=contract.pk)
